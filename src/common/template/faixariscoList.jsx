...
class FaixaRiscoList extends Component {
  ...
  setBackColorFaixaSalarial(
    faixaSalarial,
    salario,
    risco,
    posicaoFaixaSalarial
  ) {
    if (posicaoFaixaSalarial == 0) {
      ...
      faixaSalarial == posicaoFaixaSalarial
    ) {
      if (risco == 'SEM RISCO') {
        return this.getColorRiscoFrustracao(risco);
      } else if (risco == 'BAIXO RISCO') {
  ...
  getPosicaoFaixaSalarial(list, salario) {
    ...
    for (let i = 1; i < list.length; i++) {
      ...
      if (
        list[i]._faixa_salarial >= salario &&
        list[i - 1]._faixa_salarial < salario
      ) {
  ...
  renderRows() {
    ...
    return list.map((bc) => (
      <tr key={bc._faixa_salarial}>
        <td
          style={{
            width: widths._faixa_salarial,
            backgroundColor: `${this.setBackColorFaixaSalarial(
              bc._faixa_salarial,
              salario,
              labelRisco,
              posicaoFaixaSalarial
        ...
        >
          {toFormatCurrency(bc._faixa_salarial, 2)}
        </td>

        <td
          style={{
            width: widths._altorisco_menor_que,
            backgroundColor: `${this.setBackColorRiscoAlto(
              bc._faixa_salarial,
              salario,
              labelRisco,
              posicaoFaixaSalarial
        ...
        >
          {bc._altorisco_menor_que}
        </td>
        <td
          style={{
            width: widths._medio_risco_entre,
            backgroundColor: `${this.setBackColorRiscoMedio(
              bc._faixa_salarial,
              salario,
              labelRisco,
              posicaoFaixaSalarial
        ...
        >
          {bc._medio_risco_entre}
        </td>
        <td
          style={{
            width: widths._baixo_risco_entre,
            backgroundColor: `${this.setBackColorRiscoBaixo(
              bc._faixa_salarial,
              salario,
              labelRisco,
              posicaoFaixaSalarial
        ...
        >
          {bc._baixo_risco_entre}
        </td>
        <td
          style={{
            width: widths._sem_risco_maior_que,
            backgroundColor: `${this.setBackColorSemRisco(
              bc._faixa_salarial,
              salario,
              labelRisco,
              posicaoFaixaSalarial
